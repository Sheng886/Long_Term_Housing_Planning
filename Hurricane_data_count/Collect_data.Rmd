...
model1 = lm(type1^(0.1818182) ~ SVI + node1 + population + SS_scale, data = data_all)
summary(model1)
...
state_id_Gulf = c("TX","LA","MS","AL","GA","FL")
state_id_Atlantic = c("SC","NC","GA","FL")
...
write.csv(Data_Atlantic, file = "Data/Data_Atlantic.csv", row.names = FALSE)
write.csv(Data_Gulf, file = "Data/Data_Gulf.csv", row.names = FALSE)
